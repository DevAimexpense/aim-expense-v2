...
// Composition adapted from a modern agency template: large rounded hero panel with a
// floating nav + headline + dual pill CTAs + floating product cards, a trust strip,
// an about section with varied stat cards, a services row, and a 2x2 feature grid.
    ...
    <main className="relative w-full bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        ...
        <section className="relative mt-4 overflow-hidden rounded-[1.75rem] bg-gradient-to-b from-brand-600 via-brand-700 to-brand-800 px-5 pt-5 pb-0 sm:rounded-[2.25rem] sm:px-8">
          ...
          <nav className="relative z-10 flex items-center justify-between">
            ...
            <div className="hidden items-center gap-7 text-sm font-medium text-white/80 md:flex">
              <Link href="#features" className="hover:text-white">ฟีเจอร์</Link>
              <Link href="#services" className="hover:text-white">บริการ</Link>
              <Link href="/pricing" className="hover:text-white">ราคา</Link>
            </div>
            <Link href="/login" className="rounded-full px-4 py-2 text-sm font-semibold text-slate-900 shadow-sm transition-transform hover:scale-[1.02] active:scale-95" style={{ background: GREEN }}>เข้าสู่ระบบ</Link>
          </nav>
          ...
          <div className="relative z-10 mx-auto max-w-3xl pt-12 text-center sm:pt-16">
            <h1 className="le-rise text-4xl font-extrabold leading-[1.1] tracking-tight text-white text-balance sm:text-[3.4rem]">
              บันทึกค่าใช้จ่าย ออกภาษีไทย<br className="hidden sm:block" />
              <span className="text-white/70">ครบ จบใน</span> แชต LINE
            </h1>
            <p className="le-rise mx-auto mt-5 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg" style={{ animationDelay: "80ms" }}>
              Aim Expense ช่วย SME ไทยจัดการค่าใช้จ่าย–รายรับ และออกรายงานภาษี (ภ.พ.30 / ภ.ง.ด. / หัก ณ ที่จ่าย)
              ผ่าน LINE และเว็บ — ข้อมูลทั้งหมดเก็บใน Google Sheet ของคุณเอง
            </p>
            <div className="le-rise mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row" style={{ animationDelay: "140ms" }}>
              <Link href="/pricing" className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-slate-900/90 px-5 py-2.5 text-sm font-semibold text-white ring-1 ring-white/10 transition-transform hover:scale-[1.02] active:scale-95 sm:w-auto">
                ดูแพ็กเกจ &amp; ราคา
              </Link>
              <Link href="/login" className="inline-flex w-full items-center justify-center gap-2 rounded-full py-2 pl-5 pr-2 text-sm font-semibold text-slate-900 shadow-lg transition-transform hover:scale-[1.02] active:scale-95 sm:w-auto" style={{ background: GREEN }}>
                เริ่มฟรีด้วย LINE <ArrowCircle dark />
              </Link>
            </div>
            <p className="le-rise mt-4 text-xs text-white/70" style={{ animationDelay: "180ms" }}>★★★★★ ใช้ฟรีได้เลย • ทดลอง Pro 30 วัน • ไม่ต้องใช้บัตรเครดิต</p>
          </div>

          {/* floating product cards */}
          <div className="relative z-10 mx-auto flex max-w-3xl items-end justify-center gap-0 pb-10" style={{ marginTop: "3rem" }}>
            {/* left stat card (behind) */}
            ...
            <div className="le-rise relative z-20 w-[260px] overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl sm:w-[280px]" style={{ animationDelay: "160ms" }}>
              <div className="flex items-center gap-2.5 px-4 py-3 text-white" style={{ background: `linear-gradient(90deg, ${GREEN}, #04ad4c)` }}>
                ...
                <div className="text-xs font-semibold leading-tight">Aim Expense<div className="text-[10px] font-normal text-white/85">● ออนไลน์</div></div>
              </div>
              <div className="space-y-2.5 bg-slate-50 px-3 py-3.5">
                ...
                <div className="w-[88%] rounded-xl rounded-tl-sm border border-slate-200 bg-white p-3 shadow-sm">
                  <div className="inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] font-bold" style={{ background: `${GREEN}1f`, color: "#03873d" }}>
                    <svg viewBox="0 0 24 24" {...stroke} strokeWidth={3} className="h-3 w-3"><path d="m4 12 5 5L20 6" /></svg> อ่านใบเสร็จแล้ว
                  </div>
                  <div className="mt-2 space-y-1 text-[11px]">
                    <div className="flex justify-between"><span className="text-slate-500">ยอดรวม</span><span className="font-semibold">฿120.00</span></div>
                    ...
                    <div className="flex justify-between"><span className="text-slate-500">โปรเจกต์</span><span className="rounded bg-brand-50 px-1.5 font-semibold text-brand-700">Event A</span></div>
                  </div>
                  <div className="mt-2.5 rounded-md py-1.5 text-center text-[10px] font-semibold text-white" style={{ background: GREEN }}>บันทึกเป็นรายจ่าย</div>
                </div>
              </div>
            </div>
            {/* right card (behind) */}
            <div className="le-rise hidden w-44 rotate-6 translate-y-2 rounded-2xl bg-slate-900 p-4 text-white shadow-2xl sm:block" style={{ animationDelay: "240ms" }}>
              <div className="text-xs font-medium text-white/60">พร้อมยื่นภาษี</div>
        ...
        <section className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 py-8 text-sm font-semibold text-slate-400">
          <span className="text-xs font-medium uppercase tracking-wide text-slate-400">ทำงานร่วมกับ</span>
        ...
        <section className="py-10 sm:py-14">
          <Kicker>เกี่ยวกับ Aim Expense</Kicker>
          <h2 className="mx-auto max-w-3xl text-center text-2xl font-bold leading-snug tracking-tight text-balance sm:text-4xl">
            ระบบบัญชีที่ออกแบบเพื่อ <span className="text-slate-400">SME ไทย</span><br className="hidden sm:block" /> และทำงานบน <span style={{ color: GREEN }}>LINE</span> จริง
          </h2>
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl bg-brand-600 p-5 text-white shadow-sm">
              ...
              <p className="mt-2 text-sm text-white/85">ข้อมูลเก็บใน Google Sheet ใน Drive ของคุณเอง ไม่ผูกขาด</p>
            </div>
            {/* white + avatars */}
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="text-sm text-slate-500">ใช้งานง่ายทั้งทีม</div>
              <p className="mt-2 text-[15px] font-medium text-slate-800">“ถ่ายใบเสร็จส่งในกลุ่ม แล้วเข้าระบบให้เลย ลดงานคีย์ไปเยอะ”</p>
            ...
            <div className="rounded-2xl p-5 text-slate-900 shadow-sm" style={{ background: GREEN }}>
              ...
              <p className="mt-2 text-sm text-slate-900/80">รายการที่บันทึกเข้าระบบต่อเดือน</p>
            </div>
            {/* black */}
            <div className="rounded-2xl bg-slate-900 p-5 text-white shadow-sm">
              <div className="text-sm text-white/60">ครบเรื่องภาษีไทย</div>
              <div className="mt-3 text-2xl font-bold leading-tight">ภ.พ.30 · ภ.ง.ด.<br />หัก ณ ที่จ่าย</div>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="py-10 sm:py-14">
          <Kicker>สิ่งที่ทำได้</Kicker>
          <h2 className="mx-auto max-w-2xl text-center text-2xl font-bold leading-snug tracking-tight text-balance sm:text-4xl">ครบทุกขั้นตอน ตั้งแต่บันทึกจนออกภาษี</h2>
          <p className="mx-auto mt-3 max-w-xl text-center text-sm text-slate-600 sm:text-base">ไม่ว่าจะเป็นนิติบุคคลหรือบุคคลธรรมดา Aim Expense ดูแลให้ตั้งแต่ต้นจนจบ</p>
          <div className="mt-6 flex justify-center">
            <Link href="/login" className="inline-flex items-center gap-2 rounded-full bg-slate-900 py-2 pl-5 pr-2 text-sm font-semibold text-white transition-transform hover:scale-[1.02] active:scale-95">
              เริ่มใช้งาน <ArrowCircle />
            </Link>
          </div>
          <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
            {[
              { icon: <IconChat />, title: "บันทึกผ่าน LINE", desc: "ถ่ายใบเสร็จให้ AI อ่าน (OCR) หรือพิมพ์สั้นๆ ในแชต ระบบบันทึกให้ทันที — เดี่ยวหรือกลุ่มทีม" },
              { icon: <IconFlow />, title: "อนุมัติ–จ่าย–เคลียร์งบ", desc: "เวิร์กโฟลว์หลายขั้นสำหรับองค์กรจริง ตั้งเบิก → อนุมัติ → เตรียมจ่าย → เคลียร์งบ" },
              { icon: <IconTax />, title: "รายงานภาษีไทย", desc: "ออก ภ.พ.30 / ภ.ง.ด.3/53 / ใบหัก ณ ที่จ่าย / ใบกำกับภาษี ได้ครบจบในที่เดียว" },
            ].map((s) => (
              <div key={s.title} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
                <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl text-slate-900" style={{ background: GREEN }}>{s.icon}</span>
        ...
        <section id="features" className="py-10 sm:py-14">
          <Kicker>ฟีเจอร์เด่น</Kicker>
          <h2 className="mx-auto max-w-2xl text-center text-2xl font-bold leading-snug tracking-tight text-balance sm:text-4xl">ออกแบบมาเพื่อธุรกิจไทยโดยเฉพาะ</h2>
          <div className="mt-10 grid grid-cols-1 gap-4 lg:grid-cols-2">
            {[
              { icon: <IconChat />, title: "บันทึกผ่าน LINE + OCR", desc: "ถ่ายรูปใบเสร็จ ระบบอ่านยอด/VAT/ร้านค้าให้อัตโนมัติ พร้อมผูกเข้าโปรเจกต์ในคลิกเดียว" },
              { icon: <IconShield />, title: "ข้อมูลเป็นของคุณ 100%", desc: "ทุกอย่างเก็บใน Google Sheet ใน Drive ของคุณ เราไม่เก็บเนื้อหาบนเซิร์ฟเวอร์ ไม่ผูกขาด" },
              { icon: <IconBudget />, title: "คุมงบรายโปรเจกต์", desc: "ตั้งงบต่อโปรเจกต์ ติดตามใช้จ่าย–คงเหลือ และดูกำไร/ขาดทุนรายโปรเจกต์ได้ทันที" },
              { icon: <IconSwitch />, title: "บริษัท + ส่วนตัว ในแอปเดียว", desc: "รองรับทั้งนิติบุคคล (มี VAT/ภาษี) และบุคคล/ฟรีแลนซ์ จัดการได้หลายธุรกิจในบัญชีเดียว" },
            ].map((f) => (
              <div key={f.title} className="flex gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
                <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-50 text-brand-600">{f.icon}</span>
                <div>
        ...
        <section className="pb-14">
          <div className="relative overflow-hidden rounded-[1.75rem] bg-slate-900 px-6 py-14 text-center shadow-xl sm:rounded-[2.25rem] sm:px-12">
            ...
            <h2 className="relative text-2xl font-bold text-white sm:text-3xl">เริ่มทำบัญชีให้ง่ายขึ้น วันนี้</h2>
            <p className="relative mx-auto mt-3 max-w-xl text-sm text-white/70 sm:text-base">เชื่อมด้วย LINE Account ใช้ฟรี ไม่ต้องใช้บัตรเครดิต</p>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-4 px-5 py-8 sm:flex-row sm:px-6">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-slate-600">
            <Link href="/pricing" className="hover:text-slate-900">ราคา</Link>
            <Link href="/privacy" className="hover:text-slate-900">นโยบายความเป็นส่วนตัว</Link>
            <Link href="/terms" className="hover:text-slate-900">ข้อกำหนดการใช้งาน</Link>
            <a href="mailto:support@aimexpense.com" className="hover:text-slate-900">support@aimexpense.com</a>
            <Link href="/login" className="font-semibold text-brand-700 hover:text-brand-800">เข้าสู่ระบบ</Link>
          </nav>
        </div>
      </footer>
    </main>

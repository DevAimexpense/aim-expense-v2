...
// ===========================================
// ภ.ง.ด.3 ใบสรุปยอดเดือน — Client document
// A4 portrait, 1 หน้า
// ===========================================
...
export function PND3SummaryDocument({ period, periodInfo, org, stats }: Props) {
    ...
    <>
      ...
      <div className="print-toolbar no-print">
        <div className="pt-info">
          <strong>ภ.ง.ด.3 ใบสรุปยอดเดือน</strong>
      ...
      <div className="doc pnd-summary-doc">
        ...
        <div className="banner">
          <div className="banner-left">
            ...
            <div className="banner-sub">ตามมาตรา 59 แห่งประมวลรัษฎากร</div>
            <div className="banner-sub thin">
              สำหรับการหักภาษี ณ ที่จ่ายตามมาตรา 3 เตรส และมาตรา 50 (3) (4) (5)
            </div>
            <div className="banner-sub thin">
              กรณีการจ่ายเงินได้พึงประเมินตามมาตรา 40 (5) (6) (7) (8) และเสียภาษีตามมาตรา 48 ทวิ แห่งประมวลรัษฎากร
            </div>
          </div>
          <div className="banner-form">
            <div className="form-name">ภ.ง.ด.3</div>
          </div>
        </div>
        ...
        <div className="body-grid">
          ...
          <div className="col col-left">
            ...
            <div className="field-row check-line">
              ...
              <span className="cb-label"><strong>(1) ยื่นปกติ</strong></span>
              <span className="cb cb-line">
                <span className="cb-box"></span>
                <span className="cb-label">(2) ยื่นเพิ่มเติมครั้งที่</span>
                <span className="addr-line addr-sm"></span>
              </span>
            </div>

            <div className="field-row check-line">
              <span className="strong-text">นำส่งภาษีตาม</span>
              <span className="cb">
                <span className="cb-box"></span>
                <span className="cb-label">(1) มาตรา 3 เตรส</span>
              </span>
              <span className="cb">
                <span className="cb-box"></span>
                <span className="cb-label">(2) มาตรา 48 ทวิ</span>
              </span>
              <span className="cb">
                <span className="cb-box"></span>
                <span className="cb-label">(3) มาตรา 50 (3) (4) (5)</span>
              </span>
            </div>
            ...
            <div className="field-row">
              ...
              <div className="field-thin muted">
                (ให้แสดงรายละเอียดในใบแนบ ภ.ง.ด.3 หรือในสื่อบันทึกในระบบคอมพิวเตอร์อย่างใดอย่างหนึ่งเท่านั้น)
              </div>
              <div className="attach-row">
                <span className="cb cb-checked"><span className="cb-box checked">✓</span></span>
                <span><strong>ใบแนบ ภ.ง.ด.3</strong> ที่แนบมาพร้อมนี้ :</span>
...
function SummaryStyles() {
  return (
    <style>{`
      ...
      .banner-left { flex: 1; padding: 8px; background: #f0f7ff; border: 1px solid #1e3a8a;
        border-radius: 4px; }
      ...
      .form-name { font-size: 28px; font-weight: 700; color: #1e3a8a; letter-spacing: 2px; }
      ...
      .summary-table td {
        border: 1px solid #1e3a8a; padding: 4px 12px; font-size: 11.5px;
      }
